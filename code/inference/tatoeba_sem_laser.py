...
def retrieve_tatoeba(model, pooler, batch_size, device):
    ...
    for lg2 in lg_list14_1:
        ...
        emb1 = semantic_embedding(model, pooler, sources, batch_size, lg2, device)
        emb2 = semantic_embedding(model, pooler, targets, batch_size, "en", device)
    ...
    print("Length (14)", len(all_accuracies14_lgen))
    print(all_accuracies14_lgen)
    print("Length (35)", len(all_accuracies36_lgen))
    print(all_accuracies36_lgen)
