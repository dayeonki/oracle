...
def main():
    ...
    if args.model_name_or_path == "path/to/models/mSimCSE":
        tokenizer = AutoTokenizer.from_pretrained("path/to/models/xlm-r-large")
    else:
        tokenizer = AutoTokenizer.from_pretrained(args.model_name_or_path)
    model = AutoModel.from_pretrained(args.model_name_or_path).eval().to(device)
    ...
    retrieve_bucc(model, tokenizer, pooler, device)
