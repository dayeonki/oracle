    ...
    with open(logging_path, 'w') as f:
        for epoch in range(10000):
            ...
            for batch in dataloader_train:
                ...
                optimizer.zero_grad()
                loss, meaning_embedding_loss, reconstruction_loss, language_embedding_loss, language_identification_loss, additional_loss = model_loss(src_ids, tgt_ids, src_lang_label, tgt_lang_label)
